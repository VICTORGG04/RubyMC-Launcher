...
class MinecraftManager
  ...
  def execute_launch(version:, username:, uuid:, token:, ram_gb: 4, java_path: nil)
    launch(
      version_id:      version,
      username:        username,
      uuid:            uuid,
  ...
  def launch(version_id:, username:, uuid:, mc_access_token:, java_path: nil, ram_mb: 2048)
  ...
  def build_launch_args(version_meta:, version_id:, username:, uuid:, mc_access_token:, classpath:, ram_mb:)
